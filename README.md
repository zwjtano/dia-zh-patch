...
**[下载 汉化补丁](https://github.com/zwjtano/dia-zh-patch/releases/download/v0.7.0-beta.1/Dia-Chinese-Patch.zip)** · [版本发布页](https://github.com/zwjtano/dia-zh-patch/releases/tag/v0.7.0-beta.1) · [安装方法](#安装方法) · [还原方法](#还原方法) · [反馈问题](https://github.com/zwjtano/dia-zh-patch/issues)
...
安装器自动检查版本和原始资源，创建完整应用备份后应用补丁；版本不匹配时停止。
